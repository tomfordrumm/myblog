                  ...
                  <?php  if($newsletter_service == 'Sendloop'){?>
                                ...
                                <form action="http://<?php echo $sendloop_username ?>.sendloop.com/subscribe.php" method="post">
                                    <div class="search-button-holder">
                                        ...
                                        <div class="search-button-center"><input type="text" name="FormValue_Fields[EmailAddress]" value="" id="FormValue_EmailAddress" class="newsletter_email input-newsletter" src="style/img/menu-contact.png"/></div>
                                         <div class="mail-button-right"><input type="submit" name="FormButton_Subscribe" value="" id="FormButton_Subscribe" class="newsletter_button submit-newsletter"/></div>
                    ...
                    <?php  } elseif ($newsletter_service == 'MailChimp'){ ?>
                             ...
                             <form id="signup" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                                 ...
                                 <div class="search-button-holder">
                                     <div class="search-button-left"></div>
                                     <div class="search-button-center"><input type="text" name="email" id="email"  class="input-newsletter"/></div>
                                      ...
                                      <div class="mail-button-right"><input type="submit" src="" name="submit" value="" class="btn submit-newsletter" alt="Submit" /></div>
